...
#ifndef __SCIP_PROP_LOWDEGREENODES_H__
#define __SCIP_PROP_LOWDEGREENODES_H__
...
//! creates the lowdegreenodes propagator and includes it in SCIP
SCIP_EXPORT
